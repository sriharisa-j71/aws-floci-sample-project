...
public class S3ToSqsLambda implements RequestHandler<S3Event, String> {
    ...
    private static final String SSM_SQS_QUEUE_PATH = System.getenv()
            .getOrDefault("SSM_SQS_QUEUE_PATH", "/emp/sqs/queue-url");
        ...
        for (S3EventNotification.S3EventNotificationRecord record : event.getRecords()) {
            ...
            try {
                ...
                for (String line : lines) {
                    ...
                    String msgBody = mapper.writeValueAsString(emp);
    ...
    public static void main(String[] args) throws Exception {
        ...
        var bucket = System.getenv().getOrDefault("S3_BUCKET", "emp-output");
        ...
        String queueUrl = ssm.getParameter(
                GetParameterRequest.builder()
                        .name(System.getenv().getOrDefault("SSM_SQS_QUEUE_PATH", "/emp/sqs/queue-url"))
                        .build())
                .parameter().value();
